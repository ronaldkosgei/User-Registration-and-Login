...
import com.User.Registration.and.Login.repository.RoleRepository;
import com.User.Registration.and.Login.repository.UserRepository;
...
public class UserServiceImpl {
    ...
    public void saveUser(UserDto userDto) {
        User user = new User();
        user.setName(userDto.getFirstName() + " " + userDto.getSurName());
